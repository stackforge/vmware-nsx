...
admin/plugins/nsx_v3/resources/secruitygroups.py


Adding new functions is fairly straightforward:
* Define the function under appropriate package,
  ex: admin/plugins/nsx_v3/resources/function_resource.py
  We use neutron callbacks to provide hooks.
...
::
 ...
 Deprecated: Registering resources to apply quota limits to using the quota_items option is
 deprecated as of Liberty.Resource REST controllers should take care of registering resources
 with the quota engine.
