...
class NSXV3Client(object):
    ...
    def get_lport_switching_profiles(self, logical_port):
        """
        Retrieve switching profiles applied to a given nsx logical port
        """
        switching_profiles = logical_port['switching_profile_ids']
        return switching_profiles
