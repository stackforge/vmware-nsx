...
class TaaSJsonTest(base.BaseNetworkTest):
    ...
    def test_create_tap_service(self):
        ...
        device1 = {
            "description": 'mytap555', "name": tap_service_name,
    ...
    def test_create_tap_flow(self):
        ...
        self._resource_clean(fip, rsp_tap_service['tap_service'][
    ...
    def test_create_tap_flow_multiple(self):
        ...
        device_tap_service1 = {
            "description": 'tapservice1', "name": tap_service_name1,
            "port_id": self.ports[0]['id'],
            "tenant_id": self.ports[0]['tenant_id']
        }
        tap_service_name2 = data_utils.rand_name('tapservice-ch')
        device_tap_service2 = {
            "description": 'tapservice2', "name": tap_service_name2,
        ...
        device_tap_flow1 = {
            "description": 'tapflow1', "direction": "IN",
        ...
        device_tap_flow2 = {
            "description": 'tapflow2', "direction": "OUT",
        ...
        self.assertEqual(device_tap_flow2['direction'], rsp_tap_flow2[
            'tap_flow']['direction'])
        self._resource_clean(fip1, rsp_tap_service1['tap_service'][
            'id'], rsp_tap_flow1['tap_flow']['id'])
        self._resource_clean(fip2, rsp_tap_service2['tap_service'][
    ...
    def test_show_tap_flow(self):
        ...
        self.assertEqual(rsp_tap_service['tap_service'][
            'id'], rsp_tap_flow['tap_flow']['tap_service_id'])
        rsp_tap_flow_show = self.tclient.show_tf(
    ...
    def test_delete_tap_flow(self):
        ...
        self.assertEqual(rsp_tap_service['tap_service'][
            'id'], rsp_tap_flow['tap_flow']['tap_service_id'])
        rsp_tap_flow_delete = self.tclient.delete_tf(
            rsp_tap_flow['tap_flow']['id'])
        LOG.info(_LI("response from tap list : %(rsp)s") %
    ...
    def test_create_tap_flow_negative_nofloatingip(self):
        ...
        try:
            self.tclient.create_tf(**device_tap_flow)
        except Exception as e:
            LOG.info(_LI("response from  exception  %(rsp)s") % {"rsp": e})
            self._resource_clean('null', rsp_tap_service[
                                 'tap_service']['id'], 'null')
