...
def get_nsxv3client_instance():
    """
    Getting nsxv3 clinet object to query nsx manager.
    :return: nsxv3 client object.
    """
    return (nsxv3_client.NSXV3Client(CONF.nsxv3.nsx_manager,
                                     CONF.nsxv3.nsx_user,
...
def get_l2gw_client(client_mgr):
    ...
    try:
        ...
        _params = {}
    client = l2_gateway_client.L2GatewayClient(net_client.auth_provider,
                                               net_client.service,
                                               net_client.region,
...
class L2GatewayTest(base.BaseAdminNetworkTest):
    ...
    def get_bridge_cluster_info():
        nsxv3client = get_nsxv3client_instance()
