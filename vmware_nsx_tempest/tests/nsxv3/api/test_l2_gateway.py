...
class L2GatewayTest(base.BaseAdminNetworkTest):
    ...
    def setup_clients(cls):
        ...
        cls.nsxv3_client_obj = nsxv3_client.NSXV3Client(
            constants.CONF.nsxv3.nsx_manager,
            constants.CONF.nsxv3.nsx_user,
            constants.CONF.nsxv3.nsx_password)
    ...
    def resource_setup(cls):
        ...
        cls.VLAN_1 = getattr(constants.CONF.l2gw, "vlan_1", None)
        cls.VLAN_2 = getattr(constants.CONF.l2gw, "vlan_2", None)
