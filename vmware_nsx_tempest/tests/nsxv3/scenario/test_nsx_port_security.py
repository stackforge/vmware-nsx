...
class TestNSXv3PortSecurityScenario(manager.NetworkScenarioTest):
    ...
    @test.idempotent_id('f1c1d9b8-2fbd-4e7c-9ba7-a1d85d8d77d3')
    ...
    @test.attr(type='nsxv3')
    @test.idempotent_id('6853b492-8acd-4e2b-b3a0-75112cef7066')
    ...
    @test.attr(type='nsxv3')
    @test.idempotent_id('520e7847-8103-41d0-90c8-6ba52306921d')
    ...
    @test.attr(type='nsxv3')
    @test.idempotent_id('f621bbd9-c889-4c78-9ca1-7217e0df4e95')
