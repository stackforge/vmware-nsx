...
class BaseQosTest(base.BaseAdminNetworkTest):
    ...
    def resource_setup(cls):
        ...
        cls.qos_available_rule_types = (
            cls.adm_qos_client.available_rule_type())
    ...
    def create_shared_network(cls, network_name=None,
        ...
        network_name = network_name or data_utils.rand_name('shared-network')

        body = cls.networks_client.create_network(
            name=network_name, shared=True, **kwargs)
        network = body['network']
        cls.networks.append(network)
        return network

    def show_network(self, network_id):
        network = self.adm_mgr.networks_client.show_network(network_id)
...
class QosPolicyTest(BaseQosTest):
    ...
    def test_list_policy_filter_by_name(self):
        ...
        policies = self.adm_qos_client.list_policies(name='test')
    ...
    def test_delete_policy(self):
        policy = self.adm_qos_client.create_qos_policy(
    ...
    def test_policy_association_with_admin_network(self):
        ...
        self._disassociate_network(self.adm_mgr.networks_client,
                                   network['id'])
    ...
    def test_policy_association_with_tenant_network(self):
        ...
        # owned by the admin
        network = self.pri_mgr.networks_client.create_network(
        ...
        self._disassociate_network(self.pri_mgr.networks_client,
                                   network['id'])
    ...
    def test_policy_update_association_with_admin_network(self):
        ...
        self.adm_qos_client.update_network(network['id'],
                                         qos_policy_id=policy['id'])
        retrieved_network = self.show_network(network['id'])
        self.assertEqual(
            policy['id'], retrieved_network['network']['qos_policy_id'])

        self._disassociate_network(self.adm_qos_client, network['id'])

    def _disassociate_port(self, port_id):
        self.client.update_port(port_id, qos_policy_id=None)
        updated_port = self.adm_qos_client.show_port(port_id)
    ...
    def test_policy_association_with_port_shared_policy(self):
        ...
        retrieved_port = self.adm_qos_client.show_port(port['id'])
        self.assertEqual(
    ...
    def test_delete_not_allowed_if_policy_in_use_by_network(self):
        ...
        self.assertRaises(
            exceptions.Conflict,
            self.adm_qos_client.delete_qos_policy, policy['id'])
