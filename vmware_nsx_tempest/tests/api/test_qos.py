...
class BaseQosTest(base.BaseAdminNetworkTest):
    ...
    def resource_cleanup(cls):
        for network in cls.networks:
            ...
            for port in cls.adm_mgr.list_ports(network_id=network['id']):
    ...
    @classmethod
    def update_port(cls, port, client_mgr=None, **kwargs):
        client_mgr = client_mgr if client_mgr else cls.adm_mgr
    ...
    @classmethod
    def delete_port(cls, port, client_mgr=None, **kwargs):
        client_mgr = client_mgr if client_mgr else cls.adm_mgr
        body = client_mgr.ports_client.delete_port(port['id'])
        return port.get('port', body)
    ...
    @classmethod
    def show_network(self, network_id, client_mgr=None):
        client_mgr = client_mgr if client_mgr else cls.adm_mgr
        network = client_mgr.networks_client.show_network(network_id)
        return network.get('network', network)

    @classmethod
    def update_network(self, network_id, client_mgr=None, **kwargs):
        client_mgr = client_mgr if client_mgr else cls.adm_mgr
    ...
    @classmethod
    def delete_network(self, network_id, client_mgr=None):
        client_mgr = client_mgr if client_mgr else cls.adm_mgr
