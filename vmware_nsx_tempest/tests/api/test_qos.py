...
from tempest.lib.network import base
...
class BaseQosTest(base.BaseAdminNetworkTest):
    ...
    def create_shared_network(self, network_name,
...
class QosPolicyTest(BaseQosTest):
    ...
    def test_create_policy(self):
        ...
        # Test 'list policies'
        policies = self.adm_qos_client.list_qos_policies()
    ...
    def test_list_policy_filter_by_name(self):
        ...
        policies = self.adm_qos_client.list_qos_policies(name='test')
    ...
    def test_policy_update(self):
        policy = self.create_qos_policy(name='test-policy',
                                        description='',
                                        shared=False)
        self.adm_qos_client.update_qos_policy(policy['id'],
    ...
    def _disassociate_network(self, client, network_id):
        ...
        updated_network = self.adm_qos_client.show_network(network_id)
    ...
    def test_policy_association_with_admin_network(self):
        ...
        retrieved_network = self.adm_qos_client.show_network(network['id'])
        self.assertEqual(
