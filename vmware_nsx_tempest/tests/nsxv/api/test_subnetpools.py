...
class SubnetPoolsTestJSON(base.BaseNetworkTest):
    ...
    @test.idempotent_id('b39c237a-a1e8-4372-8f97-7fc9ff3660e3')
    ...
    @test.idempotent_id('de7b8aa9-0a94-4159-b3b8-4d41ae8348b1')
    ...
    @test.idempotent_id('7eaf09a1-c0d4-403d-b6ef-f9d173b61219')
    ...
    @test.idempotent_id('99c3f9dc-64e2-4868-bfed-0838345e4684')
    ...
    @test.idempotent_id('76988ed9-6eed-491c-89a5-ba4be430c7e2')
    ...
    @test.idempotent_id('bfc82211-20ae-4e3d-878d-f567bcefcec6')
    ...
    @test.idempotent_id('e6828de5-8b81-4e38-8c6f-5821ec75230f')
    ...
    @test.idempotent_id('7ecbc5c5-2c63-42e8-8120-3cf2c7e5b292')
    ...
    @test.idempotent_id('82412f8d-df29-4a23-b6c7-2c6d1035cf0b')
