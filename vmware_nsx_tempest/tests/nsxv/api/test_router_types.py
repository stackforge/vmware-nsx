...
class ExcRouterTest(base.BaseRouterTest):
    ...
    def test_create_update_delete_compact_router(self):
        self._test_create_update_delete_router_with_size('compact')
    ...
    def test_create_update_delete_xlarge_router(self):
        self._test_create_update_delete_router_with_size('xlarge', 20.0)

    @test.attr(type='nsxv')
    @test.idempotent_id('0f69bf8a-4b06-47ac-a3f7-eedba95fd395')
    def test_create_update_delete_quadlarge_router(self):
        self._test_create_update_delete_router_with_size('quadlarge', 30.0)

    def _test_create_update_delete_router_with_size(self,
                                                    router_size,
                                                    del_waitfor=10.0,
                                                    del_interval=1.5):
