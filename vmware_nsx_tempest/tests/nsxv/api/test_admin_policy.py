...
class AdminPolicyTest(base.BaseAdminNetworkTest):
    ...
    This test only deals with security-group with policy.

    WARNING: Tempest scenario tests, tenants will createsecurity-groups,
    ...
    def test_admin_can_crud_policy(self):
        ...
        try:
            sg_yoo = self.show_security_group_policy(sg_id)
            self.assertFalse(sg_yoo)
        except:
            pass
