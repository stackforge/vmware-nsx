...
class LoadBalancersTest(base.BaseTestCase):
    ...
    def test_get_load_balancer(self):
        ...
        load_balancer = self.load_balancers_client.show_load_balancer(
    ...
    def test_update_load_balancer_missing_name(self):
        ...
        loadbalancer = self.load_balancers_client.show_load_balancer(
            self.load_balancer_id)
    ...
    def test_get_load_balancer_stats(self):
        ...
        stats = self.load_balancers_client.show_load_balancer_stats(
            self.load_balancer_id)
    ...
    def test_delete_load_balancer(self):
        ...
        self.assertRaises(exceptions.NotFound,
                          self.load_balancers_client.show_load_balancer,
                          new_load_balancer_id)
