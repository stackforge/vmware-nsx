...
class TestNetworkBasicOps(manager.NetworkScenarioTest):
    ...
    def _check_network_external_connectivity(self):
        ...
        if not CONF.network.public_network_id:
            LOG.info(_LI('public network not defined.'))
            return
    ...
    def _check_server_connectivity(self, floating_ip, address_list,
        ...
        for remote_ip in address_list:
            ...
            try:
                ...
                LOG.exception(_LE("Unable to access {dest} via ssh to "
                                  "floating-ip {src}"),
                              dict(dest=remote_ip, src=floating_ip))
                raise
    ...
    @decorators.skip_because(bug="1608980")
    ...
    def test_router_rescheduling(self):
        ...
        LOG.info(_LI("Router will be assigned to %s hosting agent"), mig)
