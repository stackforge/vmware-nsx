...
class TestMultipleTransportZonesBasicOps(dmgr.TopoDeployScenarioManager):
    ...
    """Base class provide MTZ networks basic operations:

    1: craete MTZ networks with tenant network.
    ...
    4: select one VM, assign floatingip and from it ping other VMs
       to assure that VMs attached to different vdn_scope_ids, and
       tennat network are asscessible.
    """
