...
class TestAdminPolicyBasicOps(dmgr.TopoDeployScenarioManager):
    ...
    def host_can_reach_private_ips(self, host_ssh, private_ip_list):
        for dest_ip in private_ip_list:
    ...
    def run_basic_scenario(self, router_type):
        ...
        ames_1_ssh = host_ssh_reachable(self.fip_nasa_ames_1)
        jpl_3_ssh = host_ssh_reachable(self.fip_nasa_jpl_3)
