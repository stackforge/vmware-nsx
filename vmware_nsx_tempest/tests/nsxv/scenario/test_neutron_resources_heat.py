...
from vmware_nsx_tempest._i18n import _LE, _LI
...
class TemplateYAMLTestJSON(base.BaseOrchestrationTest,
    ...
    def setUp(self):
        super(TemplateYAMLTestJSON, self).setUp()
    ...
    def resource_setup(cls):
        ...
        cls.neutron_basic_template = cls.load_template('neutron_smoke')
        template = cls.read_template('neutron_smoke')
    ...
    def setup_credentials(cls):
        ...
        super(TemplateYAMLTestJSON, cls).setup_credentials()

    @classmethod
    def setup_clients(cls):
        super(TemplateYAMLTestJSON, cls).setup_clients()
    ...
    def _resource_list_check(self, resource):
        ...
        if resource == 'networks':
            ...
            component = 'OS::Neutron::Subnet'
        resource_list_id = [resource['id'] for resource in body[resource]]
        print(resource_list_id)
        test_resource_list_id = []
        for _, resource in self.test_resources.iteritems():
    ...
    def test_created_resources(self):
        ...
        for resource in self.resources:
            msg = 'rescource not create succuessfully'
    ...
    def test_topo1_same_network_connectivity_(self):
        ...
        LOG.info(_LI("response from server4 private ip : %(rsp)s") %
                 {"rsp": address_list})
