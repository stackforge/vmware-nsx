...
class TestSpoofGuardFeature(TestSpoofGuardBasicOps):
    ...
    def test_exclude_list_with_new_attach_port(self):
        ...
        # Create Port
        port = HELO.create_port_args(self, client=port_client, **kwargs)
        port_id = port['id']
        ...
        items = self.vsm.get_exclude_list_info()
    ...
    def test_exclude_with_multiple_vm(self):
        ...
        port2_id = t_floatingip2['port_id']
        port3_id = t_floatingip3['port_id']
    ...
    def test_exclude_list_with_multiple_ports(self):
        ...
        kwargs = {'name': name, 'network_id': net_id,
                  'port_security_enabled': 'false'}
        port1 = HELO.create_port_args(self, client=port_client, **kwargs)
        port2 = HELO.create_port_args(self, client=port_client, **kwargs)
        port1_id = port1['id']
