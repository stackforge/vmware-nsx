...
class TestXnetMultiSubnetsOps(dmgr.TopoDeployScenarioManager):
    ...
    defined attached to the external network.
    ...
    and no-gateway is required. Make sure the CIRD is reachable by your
    devstack.
    ...
    def create_no_gateway_subnet(cls, network_id, cidr, allocation_pool,
        ...
        """For subnets, not the first one, no-gateway should be applied."""
    ...
    def setUp(self):
        ...
        the public network and its subnets are set correctly configured.
        ...
        # only one subnet available when test started.
