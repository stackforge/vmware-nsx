...
class NetworkScenarioTest(ScenarioTest):
    ...
    def create_networks(self, client=None, tenant_id=None,
        ...
        :param network_dict: dict of key-value to create network
        :param subnet_kwargs: key-value to create subnet
        ...
        if CONF.baremetal.driver_enabled:
            ...
            subnet_kwargs.update(dict(network=network, client=client))
