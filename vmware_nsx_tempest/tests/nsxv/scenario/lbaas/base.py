...
from vmware_nsx_tempest._i18i import _
...
from vmware_nsx_tempest.tests.nsxv.scenario.lbaas import manager
...
class BaseTestCase(manager.NetworkScenarioTest):
    ...
    def _check_load_balancing_after_deleting_resources(self):
        """Check that the requests are not sent to any servers and:
