...
class TestLBaaSV2BasicOps(dmgr.TopoDeployScenarioManager):
    ...
    1. Create netowrk with exclusive router, and 2 servers
    ...
    5. Send NUM requests vip's floating ip and check that they are shared
    ...
    def tearDown(self):
        ...
        # delete router to make sure no interface attached to router
        self.router.delete()
        self.subnet.delete()
        self.network.delete()
