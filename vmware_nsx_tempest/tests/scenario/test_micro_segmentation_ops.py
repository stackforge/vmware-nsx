...
from vmware_nsx_tempest.lib import topology_creator
...
class TestMicroSegmentationOps(topology_creator.TopologyBuilder):
    ...
    def micro_segmentation_topology(self):
        config = {
            "router_1": {
                "router_attribute": {},
                "network_web": {
    ...
    def test_micro_segmentation_ops(self):
        ...
        return
        self.micro_segmentation_topology()
