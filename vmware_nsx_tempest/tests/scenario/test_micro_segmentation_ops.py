...
class TestMicroSegmentaionOps(manager.NetworkScenarioTest):

    """Test suite for micro-segmentaion scenario test
    ...
    @classmethod
    def skip_checks(cls):
        super(TestMicroSegmentaionOps, cls).skip_checks()
    ...
    def setup_credentials(cls):
        ...
        super(TestMicroSegmentaionOps, cls).setup_credentials()

    def setUp(self):
        super(TestMicroSegmentaionOps, self).setUp()
        self.keypairs = {}
    ...
    def test_micro_segmentation_ops(self):
        """Test micro-segmentaion use case
