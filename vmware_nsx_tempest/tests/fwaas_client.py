...
from vmware_nsx_tempest.services import fwaas_api_client
...
class FWaaSClientMixin(object):
    ...
    def resource_setup(cls):
        ...
        manager = cls.manager
        cls.firewalls_client = fwaas_api_client.FirewallsClient(
        ...
        cls.firewall_policies_client = fwaas_api_client.FirewallPoliciesClient(
            manager.auth_provider,
            CONF.network.catalog_type,
            CONF.network.region or CONF.identity.region,
            endpoint_type=CONF.network.endpoint_type,
            ...
            build_timeout=CONF.network.build_timeout,
            **manager.default_params)
        cls.firewall_rules_client = fwaas_api_client.FirewallRulesClient(
            manager.auth_provider,
            CONF.network.catalog_type,
            CONF.network.region or CONF.identity.region,
            endpoint_type=CONF.network.endpoint_type,
