...
class NSXClient(object):
    ...
    def cleanup_loadbalancer(self):
        ...
        # lb services
        objects = self.get_os_lb_objects(self.nsxlib.load_balancer.service,
        ...
        # listeners
        objects = self.get_os_lb_objects(
        ...
        # pools
        objects = self.get_os_lb_objects(self.nsxlib.load_balancer.pool,
                                         nsx_models.NsxLbaasPool, 'lb_pool_id')
        self.clean_lb_objects('pool', self.nsxlib.load_balancer.pool,
                              objects)

        # health monitors
        objects = self.get_os_lb_objects(self.nsxlib.load_balancer.monitor,
