...
class NSXClient(object):
    ...
    def get_os_logical_router_ports(self, lrouter):
        """
        Retrive all logical router ports created from Neutron NSXv3 plugin
        """
    ...
    def get_tier0_logical_routers(self):
        lrouters = self.get_logical_routers()
        tier0_routers = [router for router in lrouters
                         if router['router_type'] == 'TIER0']
        return tier0_routers
