...
from nsxadmin.nsx_plugins.nsxv3.resources import routers
...
def init_registry():
    ...
    registry.subscribe(sg.nsx_clean_security_groups,
                       Resources.SECURITY_GROUPS,
                       Operations.CLEAN)
    registry.subscribe(routers.neutron_list_routers,
                       Resources.ROUTERS,
                       Operations.LIST)
    registry.subscribe(routers.neutron_clean_routers,
                       Resources.ROUTERS,
                       Operations.CLEAN)
