...
TODO: Move towards design like openstack clients
...
cli_opts = [
            ...
            cfg.StrOpt('operation',
                       ...
                       'list, clean, sync, nsx_list, nsx_clean, '
...
class Constants(object):
    ...
    VERSION = '0.1'
    USAGE = 'python admin_util.py --resource <resource_name> --operation <operation>'
...
def init_registry():
    ...
    registry.subscribe(nsx_list_security_groups,
                       Resources.SECURITY_GROUPS,
                       Operations.NSX_LIST)
    registry.subscribe(nsx_clean_security_groups,
                       Resources.SECURITY_GROUPS,
