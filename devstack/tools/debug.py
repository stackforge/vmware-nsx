...
def init_registry():
    registry.subscribe(get_resource, Resources.PORTS, Operations.LIST)
    registry.subscribe(get_resource, Resources.EDGES, Operations.LIST)
    registry.subscribe(cleanup_security_groups, Resources.SECURITY_GROUPS,
                       Operations.CLEAN)
    registry.subscribe(list_security_groups, Resources.SECURITY_GROUPS,
                       Operations.LIST)
