...
from neutron.plugins.vmware.dbexts import vnic_index_db
from neutron.plugins.vmware.extensions import metadata_providers as subnet_md
from neutron.plugins.vmware.extensions import vnic_index as ext_vnic_idx
from neutron.plugins.vmware.plugins import nsx_v_md_proxy
from neutron.plugins.vmware.vshield.common import constants as vcns_const
from neutron.plugins.vmware.vshield.common import exceptions as vsh_exc
from neutron.plugins.vmware.vshield import edge_utils
from neutron.plugins.vmware.vshield import securitygroup_utils
...
class NsxVPluginV2(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def _get_subnet_md_providers(self, context, subnet):
        ...
        md_provider_data = vcns_db.get_edge_vnic_bindings_by_int_lswitch(
    ...
    def _update_dhcp_service_with_subnet(self, context, subnet):
        ...
        if phy_net:
            ...
            for net_id in network_ids:
                p_net = nsx_db.get_network_bindings(context.session,
                                                    net_id['id'])
    ...
    def _get_section_uri(self, session, security_group_id, type):
        mapping = nsx_db.get_nsx_section(session, security_group_id)
    ...
    def create_security_group(self, context, security_group,
        ...
        try:
            with context.session.begin(subtransactions=True):
                ...
                nsx_db.add_neutron_nsx_section_mapping(
                    context.session, new_security_group['id'],
                    section_uri)
                ...
                for pair in rule_pairs:
                    ...
                    nsx_db.add_neutron_nsx_rule_mapping(
    ...
    def delete_security_group(self, context, id):
        ...
        try:
            with context.session.begin(subtransactions=True):
                ...
                section_mapping = nsx_db.get_nsx_section(
    ...
    def delete_security_group_rule(self, context, sgrid):
        ...
        try:
            with context.session.begin(subtransactions=True):
                ...
                nsx_rule_id = nsx_db.get_nsx_rule_id(
