...
from neutron.plugins.vmware.vshield import nsxv_loadbalancer as nsxv_lb
...
class NsxVMetadataProxyHandler:
    ...
    def _get_internal_network(self):
        ...
        net_list = vcns_db.get_nsxv_internal_network(
    ...
    def _create_internal_network(self):
        ...
        try:
            vcns_db.create_nsxv_internal_network(
                self.context.session,
                vcns_const.InternalEdgePurposes.INTER_EDGE_PURPOSE,
                internal_net)
    ...
    def _get_proxy_edges(self):
        ...
        rtr_list = vcns_db.get_nsxv_internal_edges_by_purpose(
            self.context.session,
            vcns_const.InternalEdgePurposes.INTER_EDGE_PURPOSE)
    ...
    def _create_proxy_edges(self):
        ...
        for rtr_ip in cfg.CONF.nsxv.mgt_net_proxy_ips:
            ...
            #  and resume
            try:
                vcns_db.create_nsxv_internal_edge(
                    self.context.session,
                    rtr_ip,
                    vcns_const.InternalEdgePurposes.INTER_EDGE_PURPOSE,
                    rtr_id)
                ...
                rtr_id = vcns_db.get_nsxv_internal_edge(self.context, rtr_ip)
    ...
    def _setup_metadata_lb(
        ...
        binding = vcns_db.get_vcns_router_binding(self.context.session, rtr_id)
