...
- Create new BGP GW edge::
    ...
    nsxadmin -r bgp-gw-edge -o create --property name=<NAME> --property local-as=<ASN> --property external-iface=<PORTGROUP>:<IP_ADDRESS/PREFIX_LEN> --property internal-iface=<PORTGROUP>:<IP_ADDRESS/PREFIX_LEN>
