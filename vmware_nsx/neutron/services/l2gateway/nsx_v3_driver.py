...
from vmware_nsx.neutron.plugins.vmware.dbext import db as nsx_db
...
class NsxV3Driver(l2gateway_db.L2GatewayMixin):
    ...
    def subscribe_callback_notifcations(self):
    ...
    def _validate_network(self, context, gw_connection):
        ...
        if (not network_type or
            network_type != nsx_utils.NsxV3NetworkTypes.VXLAN):
    ...
    def delete_l2_gateway_connection(self, context, l2_gateway_connection):
        ...
        nsxlib.delete_bridge_endpoint(conn_mapping.get('bridge_endpoint_id'))
