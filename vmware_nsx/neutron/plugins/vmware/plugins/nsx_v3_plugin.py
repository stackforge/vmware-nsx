...
class NsxV3Plugin(db_base_plugin_v2.NeutronDbPluginV2,
    ...
    def create_port(self, context, port):
        ...
        with context.session.begin(subtransactions=True):
            ...
            if sgids is not None:
                ...
                security._update_lport_with_security_groups(
    ...
    def create_security_group(self, context, security_group, default_sg=False):
        ...
        name = security._get_nsgroup_name(security_group_db)
        ...
        try:
            ...
            rules = security._create_firewall_rules(
            ...
            with excutils.save_and_reraise_exception():
                ...
                super(self, NsxV3Plugin).delete_security_group(
        ...
        security._save_sg_mappings(context.session, security_group_db['id'],
                                   ns_group['id'], firewall_section['id'])
        security._save_sg_rule_mappings(context.session, rules['rules'])

        return security_group_db

    def update_security_group(self, context, id, security_group):
        nsgroup_id, section_id = security._get_sg_mappings(context.session, id)
        updated_security_group = (
            super(NsxV3Plugin, self).update_security_group(context, id,
                                                           security_group))
        name = security._get_nsgroup_name(updated_security_group)
    ...
    def create_security_group_rule_bulk(self, context, security_group_rules):
        ...
        nsgroup_id, section_id = security._get_sg_mappings(context.session,
                                                           sg_id)
        try:
            rules = security._create_firewall_rules(
    ...
    def delete_security_group_rule(self, context, id):
        ...
        _, section_id = security._get_sg_mappings(context.session, sg_id)
        fw_rule_id = security._get_sg_rule_mapping(context.session, id)
