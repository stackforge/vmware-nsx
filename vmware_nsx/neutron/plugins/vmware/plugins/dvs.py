...
from neutron.plugins.vmware.dvs import dvs
from neutron.plugins.vmware.dvs import dvs_utils
...
class NsxDvsV2(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def __init__(self):
        ...
        # An in memory cache of network types. This will be a dictionary
        # with the key net_id and the type of the network as the value.
        self._network_type_cache = {}
    ...
    def _dvs_create_network(self, context, network):
        ...
        vlan_tag = 0
        if net_data.get(pnet.NETWORK_TYPE) == NetworkTypes.VLAN:
        ...
        self._network_type_cache[new_net['id']] = 'dvs'
        return new_net
    ...
    def delete_network(self, context, id):
        ...
        self._network_type_cache.pop(id, None)
