...
def add_nsxv_lbaas_listener_binding(session, listener_id, loadbalancer_id,
                                    app_profile_id, vse_id):
    pass


def get_nsxv_lbaas_listener_binding(session, listener_id, loadbalancer_id):
    pass


def del_nsxv_lbaas_listener_binding(session, listener_id, loadbalancer_id):
    pass


def get_nsxv_lbaas_pool_binding(session, pool_id):
    pass
