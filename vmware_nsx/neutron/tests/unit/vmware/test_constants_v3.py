...
FAKE_BRIDGE_TZ_UUID = uuidutils.generate_uuid()
FAKE_BRIDGE_SWITCH_UUID = uuidutils.generate_uuid()
...
FAKE_BRIDGE_SWITCH = {
    "id": FAKE_BRIDGE_SWITCH_UUID,
    "display_name": FAKE_NAME,
    "resource_type": "LogicalSwitch",
    "address_bindings": [],
    "transport_zone_id": FAKE_BRIDGE_TZ_UUID,
    "replication_mode": "MTEP",
    "admin_state": "UP",
    "vni": 50056,
    "switching_profile_ids": [
