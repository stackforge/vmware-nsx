# Copyrigh (c) 2012 OpenStack Foundation.
#
...
class TestSharedRouterTestCase(L3NatTest, L3NatTestCaseBase,
    ...
    def test_get_available_and_conflict_router_ids_with_no_conflict(self):
        with contextlib.nested(
            self.router(),
            self.router()) as (r1, r2):
            with contextlib.nested(
                ...
                self.subnet(cidr='12.0.0.0/24')) as (s1, s2):
                    ...
                    available_router_ids, conflict_router_ids = (
                        router_driver._get_available_and_conflict_router_ids(
    ...
    def test_get_available_and_conflict_router_ids_with_conflict(self):
        with contextlib.nested(
            self.router(),
            self.router()) as (r1, r2):
            with contextlib.nested(
    ...
    def test_get_available_and_conflict_router_ids_with_diff_gw(self):
        with contextlib.nested(
            self.router(),
            self.router(),
            self.network(),
