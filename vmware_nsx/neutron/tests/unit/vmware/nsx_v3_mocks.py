...
def update_logical_port(lport_id, existing_payload, name=None,
                        admin_state=None):
    if name:
        existing_payload['display_name'] = name
    if admin_state is not None:
        if admin_state:
            existing_payload['admin_state'] = nsx_constants.ADMIN_STATE_UP
        else:
            existing_payload['admin_state'] = nsx_constants.ADMIN_STATE_DOWN
