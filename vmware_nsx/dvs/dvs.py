...
class DvsManager(VCManagerBase):
    ...
    def update_port_group_spec_teaming(self, pg_spec, teaming_data):
        ...
        if dvs_moref.value in failover_uplinks:
            dvs_uplinks = failover_uplinks[dvs_moref.value]
            policy.uplinkPortOrder.activeUplinkPort = dvs_uplinks['active']
            policy.uplinkPortOrder.standbyUplinkPort = dvs_uplinks['standby']
        else:
