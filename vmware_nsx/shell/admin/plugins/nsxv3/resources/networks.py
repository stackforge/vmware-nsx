...
from vmware_nsx._i18n import LE, _LI, LW
...
def delete_backend_network(resource, event, trigger, **kwargs):
    ...
    try:
        ...
        LOG.error(_LE("Failed to delete backend network %(id)s : %(e)s."), {
            'id': nsx_id, 'e': e})
        return
    ...
    try:
        ...
        LOG.error(_LE("Failed to delete backend network %s."), nsx_id)
