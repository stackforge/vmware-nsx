...
class NSXClient(object):
    ...
    def create_logical_dhcp_server(self, dhcp_profile, server_ip):
        """
    ...
    def create_logical_switch_port(self, lswitch_id, attachment):
        """
    ...
    def create_static_binding(self, dhcp_server_id, mac, ip):
        """
