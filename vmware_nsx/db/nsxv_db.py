...
def warn_on_binding_status_error(get_binding_func):
    def warn_func(*args, **kwds):
        result = get_binding_func(*args, **kwds)
        if result is None:
            return
        ...
        for binding in bindings:
            if binding and binding['status'] == plugin_const.ERROR:
