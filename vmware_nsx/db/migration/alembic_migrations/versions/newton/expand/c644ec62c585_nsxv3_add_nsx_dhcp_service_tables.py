...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['neutron_id'], ['networks.id'],
                                ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('neutron_id', 'nsx_service_type'))
    ...
    op.create_table(
        ...
        sa.Column('mac', sa.String(36), nullable=False),
        sa.Column('ip', sa.String(36), nullable=False),
        sa.ForeignKeyConstraint(['neutron_id'], ['ports.id'],
                                ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('neutron_id', 'nsx_binding_id'))
