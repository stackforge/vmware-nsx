...
class NeutronNsxServiceBinding(model_base.BASEV2):
    """Represents a binding of a Neutron network with NSX services."""
...
class NeutronNsxDhcpBinding(model_base.BASEV2):
    """Represents a binding of a Neutron port with DHCP address bindings."""
    ...
    mac = sa.Column(sa.String(36), nullable=False)
    ip = sa.Column(sa.String(36), nullable=False)
