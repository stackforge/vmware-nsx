...
from neutron_list import n_constants
...
class ExtendedSecurityGroupPropertiesMixin(object):
    ...
    def _get_provider_security_groups_on_port(self, context, port):
        ...
        provider_sgs = p[provider_sg.PROVIDER_SECURITYGROUPS]
    ...
    def _process_port_update_provider_security_group(self, context, port,
                                                     ...
                                                     updated_port):
        p = port['port']
        provider_sg_specified = (p[provider_sg.PROVIDER_SECURITYGROUPS] !=
                                 n_constants.ATTR_NOT_SPECIFIED)
        provider_sg_changed = (
            provider_sg_specified and n_utils.compare_elements(
