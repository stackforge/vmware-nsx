...
class L3NatTestCaseBase(test_l3_plugin.L3NatTestCaseMixin):
    ...
    def test_create_floatingip_with_specific_ip(self):
        return super(L3NatTestCaseBase,
                     self).test_create_floatingip_with_specific_ip()

    @with_no_dhcp_subnet
    def test_floatingip_same_external_and_internal(self):
        return super(L3NatTestCaseBase,
                     self).test_floatingip_same_external_and_internal()

    @with_no_dhcp_subnet
    def test_floatingip_multi_external_one_internal(self):
        return super(L3NatTestCaseBase,
                     self).test_floatingip_multi_external_one_internal()
    ...
    def test_router_add_interface_ipv6_port_existing_network_returns_400(self):
        return super(L3NatTestCaseBase, self).\
...
class TestVdrTestCase(L3NatTest, L3NatTestCaseBase,
    ...
    @with_no_dhcp_subnet
    def test_router_add_interface_ipv6_port_existing_network_returns_400(self):
        return super(TestVdrTestCase, self).\
            test_router_add_interface_ipv6_port_existing_network_returns_400()
