...
class TestL3ExtensionManager(object):
    ...
    def get_resources(self):
        ...
        l3.L3().update_attributes_map(dist_router.EXTENDED_ATTRIBUTES_2_0)
        l3.L3().update_attributes_map(router_type.EXTENDED_ATTRIBUTES_2_0)
        l3.L3().update_attributes_map(router_size.EXTENDED_ATTRIBUTES_2_0)
        l3.L3().update_attributes_map(
            router_availability_zone.EXTENDED_ATTRIBUTES_2_0)
        l3.L3().update_attributes_map(l3_flavors.EXTENDED_ATTRIBUTES_2_0)
