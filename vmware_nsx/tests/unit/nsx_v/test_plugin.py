...
class TestNSXPortSecurity(test_psec.TestPortSecurity,
    ...
    def _create_no_sec_compute_port(self, network_name, device_id):
    ...
    def test_update_port_no_security_with_vnic(self):
        ...
        port = self._create_no_sec_compute_port('net1', device_id)
