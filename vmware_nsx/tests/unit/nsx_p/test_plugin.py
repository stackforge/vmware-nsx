...
class NsxPPluginTestCaseMixin(
        ...
        if self.force_disable_dhcp:
            if 'enable_dhcp' in kwargs:
                ...
                if len(args) > 7:
                    ...
                    arg_list[7] = False
                    args = tuple(arg_list)
        return super(NsxPPluginTestCaseMixin,
                     self)._make_subnet(*args, **kwargs)
    ...
    def _create_subnet(self, fmt, net_id, cidr,
        ...
        return super(NsxPPluginTestCaseMixin, self)._create_subnet(
...
class NsxPTestPorts(test_db_base_plugin_v2.TestPortsV2,
    ...
    def test_create_port_with_ipv6_dhcp_stateful_subnet_in_fixed_ips(self):
        self.skipTest('Stateful DHCPv6 not supported')
...
class NsxPTestSubnets(test_db_base_plugin_v2.TestSubnetsV2,
    ...
    def _test_create_subnet(self, network=None, expected=None, **kwargs):
        ...
        if not self.force_slaac:
            return

        if 'ipv6_ra_mode' in kwargs and 'ipv6_address_mode' in kwargs:
    ...
    def test_create_subnet_ipv6_gw_values(self):
        super(NsxPTestSubnets, self).test_create_subnet_ipv6_gw_values()
