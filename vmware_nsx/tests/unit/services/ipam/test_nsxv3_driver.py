...
class TestNsxv3IpamSubnets(test_plugin.TestSubnetsV2):
    ...
    #             # create ports on this subnet until there are no more
    #             # free ips
...
class TestNsxv3IpamPorts(test_plugin.TestPortsV2):
