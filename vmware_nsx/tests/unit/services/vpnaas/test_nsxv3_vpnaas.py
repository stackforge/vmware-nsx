...
class TestDriverValidation(base.BaseTestCase):
    ...
    def _test_conn_validation(self, conn_params, success=True,
                              connections=None):
    ...
    def test_dpd_validation(self):
        params = {'dpd': {'action': 'hold',
                          'timeout': 120}}
        self._test_conn_validation(params, success=True)

        params = {'dpd': {'action': 'clear',
                          'timeout': 120}}
        self._test_conn_validation(params, success=False)
