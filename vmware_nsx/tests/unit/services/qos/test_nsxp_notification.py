...
class TestQosNsxPNotification(base.BaseQosTestCase,
    ...
    def test_policy_create_profile(self, fake_db_add, fake_rbac_create):
        ...
        with mock.patch(
            'vmware_nsxlib.v3.policy_resources.NsxQosProfileApi.create',
    ...
    def __test_policy_update_profile(self, *mocks):
        # test the profile update when a QoS policy is updated
    ...
    def test_policy_delete_profile(self, *mocks):
        ...
        with mock.patch(
            'vmware_nsxlib.v3.policy_resources.NsxQosProfileApi.delete') as delete_profile:
