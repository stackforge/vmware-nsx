...
class TestNsxOctaviaListener(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.ctx = None
        mock.patch("neutron_lib.context.Context").start()
    ...
    def test_healthmonitor_create(self):
        ...
        self.clientMock.cast.assert_called_once_with(
            {}, 'set_completion_state',
            obj_type=d_const.HEALTHMONITOR,
            obj_id=self.dummyObj['id'],
            success=True)
