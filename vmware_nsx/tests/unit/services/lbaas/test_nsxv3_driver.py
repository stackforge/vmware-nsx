...
class TestEdgeLbaasV2Pool(BaseTestEdgeLbaasV2):
    ...
    def _verify_create(self, res_type, cookie_name, cookie_mode,
                       mock_create_pp, mock_update_pp, mock_delete_pp):
        if cookie_name:
            mock_create_pp.assert_called_once_with(
    ...
    def _test_setup_pool_persistence(self, session_persistence,
        ...
        with mock.patch.object(self.pp_client, 'create'
            ...
            pp_id = self.edge_driver.pool.implementor._setup_pool_persistence(
    ...
    def test_setup_pool_persistence_sourceip_new_profile(self):
        sess_persistence = lb_models.SessionPersistence(POOL_ID, 'SOURCE_IP')
        res_type = 'LbSourceIpPersistenceProfile'
        self._test_setup_pool_persistence(sess_persistence, res_type,
                                          {'id': LB_VS_ID},
                                          self._verify_create)

    def test_setup_pool_persistence_httpcookie_new_profile(self):
    ...
    def test_setup_pool_persistence_appcookie_new_profile(self):
        sess_persistence = lb_models.SessionPersistence(POOL_ID, 'APP_COOKIE',
                                                        'whatever')
        res_type = 'LbCookiePersistenceProfile'
        self._test_setup_pool_persistence(sess_persistence, res_type,
                                          {'id': LB_VS_ID},
    ...
    def test_setup_pool_persistence_none_from_existing(self):
        sess_persistence = None
        self._test_setup_pool_persistence(
            sess_persistence, None,
            {'id': LB_VS_ID, 'persistence_profile_id': LB_PP_ID},
            self._verify_delete)

    def test_setup_pool_persistence_sourceip_from_existing(self):
        sess_persistence = lb_models.SessionPersistence(POOL_ID, 'SOURCE_IP')
        res_type = 'LbSourceIpPersistenceProfile'
        self._test_setup_pool_persistence(
    ...
    def test_setup_pool_persistence_httpcookie_from_existing(self):
        sess_persistence = lb_models.SessionPersistence(POOL_ID, 'HTTP_COOKIE')
        res_type = 'LbCookiePersistenceProfile'
        self._test_setup_pool_persistence(
            sess_persistence, res_type,
    ...
    def test_setup_pool_persistence_appcookie_from_existing(self):
        sess_persistence = lb_models.SessionPersistence(POOL_ID, 'APP_COOKIE',
                                                        'whatever')
        res_type = 'LbCookiePersistenceProfile'
        self._test_setup_pool_persistence(
