...
class TestApiReplay(test_plugin.NsxV3PluginTestCaseMixin):
    ...
    def setUp(self, plugin=None, ext_mgr=None, service_plugins=None):
        ...
        self.orig_sg_validator = ext_sg._validate_name_not_default
    ...
    def tearDown(self):
        ...
        # back to the default validators
        ext_sg._validate_name_not_default = self.orig_sg_validator
        # DEBUG ADIT
        #if validators.validators.get('type:name_not_default'):
        #    del validators.validators['type:name_not_default']
