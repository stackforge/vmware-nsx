...
def _mock_nsx_backend_calls():
    ...
    mock.patch(
        "vmware_nsx.nsxlib.v3.dfw_api.create_nsgroup",
        side_effect=_return_id_key
    ).start()

    mock.patch(
        "vmware_nsx.nsxlib.v3.dfw_api.create_empty_section",
        side_effect=_return_id_key).start()

    mock.patch(
        "vmware_nsx.nsxlib.v3.security._init_default_section",
        side_effect=_return_id_key).start()

    mock.patch(
        "vmware_nsx.nsxlib.v3.security.create_firewall_rules",
