...
class TestL3NatTestCase(L3NatTest,
    ...
    @with_external_subnet
    # DEBUG ADIT why fails?
    def test_router_add_gateway_dup_subnet1_returns_400(self):
        super(TestL3NatTestCase,
              self).test_router_add_gateway_dup_subnet1_returns_400()
    ...
    def test_router_add_interface_by_port_cidr_overlapped_with_gateway(self):
        super(TestL3NatTestCase,
              self).test_router_add_interface_by_port_cidr_overlapped_with_gateway()
    ...
    def test_network_update_external_failure(self):
        super(TestL3NatTestCase,
              self).test_network_update_external_failure()
    ...
    def test_network_update_external(self):
        super(TestL3NatTestCase,
              self).test_network_update_external()
    ...
    @with_external_subnet
    def floatingip_no_assoc(self, private_sub, **kwargs):
        return super(TestL3NatTestCase,
              self).floatingip_no_assoc(private_sub, **kwargs)
