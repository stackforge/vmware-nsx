...
class NsxNativeMetadataTestCase(NsxV3PluginTestCaseMixin):
    ...
    def setUp(self):
        ...
        self._patcher.start()
        # Need to run _init_native_metadata() manually because plugin was
    ...
    def test_metadata_proxy_configuration(self):
        ...
        self.assertRaises(cfg.RequiredOptError, self.plugin._init_metadata)
