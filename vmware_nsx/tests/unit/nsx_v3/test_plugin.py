...
def _mock_nsx_backend_calls():
    ...
    # TODO(asarfaty): need to upgrade this mock to 2.2.
    # Currently it breaks the router tests.
    mock.patch(
...
class TestNetworksV2(test_plugin.TestNetworksV2, NsxV3PluginTestCaseMixin):
    ...
    def setUp(self, plugin=PLUGIN_NAME,
        ...
        self.features_mock = mock.patch(
            "vmware_nsxlib.v3.NsxLib.feature_supported",
            return_value=True)
        self.features_mock.start()
        super(TestNetworksV2, self).setUp(plugin=plugin,
                                          ext_mgr=ext_mgr)

    def tearDown(self):
        super(TestNetworksV2, self).tearDown()
        self.features_mock.stop()
