...
class NativeDhcpTestCase(NsxV3PluginTestCaseMixin):
    ...
    def _test_update_dhcp_binding(self, subnet, port_data, update_data,
                                  assert_data):
        # Test if DHCP binding is updated.
        with mock.patch.object(nsx_resources.LogicalDhcpServer,
    ...
    def test_dhcp_binding_with_update_port_ip(self):
        ...
        with self.subnet(cidr='10.0.0.0/24', enable_dhcp=True) as subnet:
            ...
            self._test_update_dhcp_binding(subnet, port_data, update_data,
                                           assert_data)
