...
class MemoryMockAPIProvider(nsx_client.AbstractHTTPProvider):
...
class NsxClientTestCase(NsxLibTestCase):
    ...
    class MockNSXClusteredAPI(nsx_client.NSXClusteredAPI):
        ...
        def record_call(self, request, **kwargs):
            ...
            # filter out requests specific attrs
    ...
    class MockHTTPProvider(nsx_client.NSXRequestsHTTPProvider):
    ...
    def new_mocked_client(self, client_class, mock_validate=True,
                          session_response=None, **kwargs):
        client = client_class(self.mock_nsx_clustered_api(
    ...
    def mocked_rest_fns(self, module, attr, mock_validate=True):
        client = nsx_client.NSX3Client(self.mock_nsx_clustered_api())
