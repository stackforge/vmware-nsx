...
# Cache the pointers to those functions because they could be overridden
# by other running tests.
nsxlib_create_logical_port = nsxlib.create_logical_port
nsxlib_delete_logical_port = nsxlib.delete_logical_port
...
class NsxLibPortTestCase(nsxlib_testcase.NsxLibTestCase):
    ...
    def test_create_logical_port(self, mock_create_resource):
        ...
        result = nsxlib_create_logical_port(
    ...
    def test_delete_logical_port(self, mock_delete_resource):
        ...
        result = nsxlib_delete_logical_port(test_constants_v3.FAKE_PORT['id'])
