...
class NSXBgpPlugin(service_base.ServicePluginBase, bgp_db.BgpDbMixin):
    ...
    def _get_driver_by_project(self, context, project):
        ...
        if self._core_plugin.is_tvd_plugin():
            ...
            if plugin_type != projectpluginmap.NsxPlugins.NSX_V:
        ...
        if not self.nsxv_driver:
            msg = _("NSX-V dynamic routing driver was not found")
            raise n_exc.InvalidInput(error_message=msg)

        return self.nsxv_driver
