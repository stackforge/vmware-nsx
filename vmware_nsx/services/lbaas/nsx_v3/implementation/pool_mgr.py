...
class EdgePoolManagerFromDict(base_mgr.Nsxv3LoadbalancerBaseManager):
    ...
    def create(self, context, pool, obj=None, completor=None):
    ...
    def update(self, context, old_pool, new_pool, obj=None, completor=None):
        pool_client = self.core_plugin.nsxlib.load_balancer.pool
        pool_name = None
        tags = None
        lb_algorithm = None
    ...
    def delete(self, context, pool, obj=None, completor=None):
        lb_id = pool['loadbalancer_id']
        pool_client = self.core_plugin.nsxlib.load_balancer.pool
        vs_client = self.core_plugin.nsxlib.load_balancer.virtual_server
