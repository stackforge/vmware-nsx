...
class EdgeLoadBalancerManagerFromDict(base_mgr.Nsxv3LoadbalancerBaseManager):
    ...
    def create(self, context, lb, obj=None, completor=None):
    ...
    def update(self, context, old_lb, new_lb, obj=None, completor=None):
                ...
                if binding:
                    ...
                    try:
                        ...
                        with excutils.save_and_reraise_exception():
                            if completor:
                                completor.lbv2_driver.pool.failed_completion(
                                    context, obj)
    ...
    def delete(self, context, lb, obj=None, completor=None):
