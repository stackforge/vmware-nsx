    ...
    def create(self, context, hm):
        ...
        if binding:
            ...
            try:
                ...
                with excutils.save_and_reraise_exception():
                    self.lbv2_driver.health_monitor.failed_completion(context, hm)
                    LOG.error('Failed to attach monitor %s to pool %s',
    ...
    def delete(self, context, hm):
        ...
        if binding:
            ...
            try:
                ...
                with excutils.save_and_reraise_exception():
                    self.lbv2_driver.health_monitor.failed_completion(
                        context, hm)
                    LOG.error('Failed to remove monitor %s from pool %s',
            ...
            try:
                ...
                with excutils.save_and_reraise_exception():
                    self.lbv2_driver.health_monitor.failed_completion(context, hm)
                    LOG.error('Failed to delete monitor %s from backend',
                              lb_monitor_id)
