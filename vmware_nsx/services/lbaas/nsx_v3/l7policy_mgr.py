...
class EdgeL7PolicyManager(base_mgr.Nsxv3LoadbalancerBaseManager):
    ...
    def _update_policy_position(self, vs_id, rule_id, position):
        ...
        vs_client.update(rule_ids=lb_rules)
    ...
    def create(self, context, policy):
        ...
        try:
            ...
            self.lbv2_driver.l7rule.failed_completion(context, policy)
        ...
        self.lbv2_driver.l7rule.successful_completion(context, policy)
    ...
    def update(self, context, old_policy, new_policy):
        ...
        try:
            ...
            if new_policy.position != new_policy.position:
        ...
        self.lbv2_driver.l7rule.successful_completion(context, new_policy)
