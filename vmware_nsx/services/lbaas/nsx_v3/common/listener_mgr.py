...
class EdgeListenerManagerFromDict(base_mgr.Nsxv3LoadbalancerBaseManager):
    ...
    def create(self, context, listener, listener_obj=None, certificate=None):
        ...
        try:
            ...
            self.failed_completion(context, listener_obj)
        ...
        nsx_db.add_nsx_lbaas_listener_binding(
            ...
            virtual_server['id'])
        self.successful_completion(context, listener_obj)
    ...
    def delete(self, context, listener, listener_obj=None):
        lb_id = listener['loadbalancer_id']
        nsxlib_lb = self.core_plugin.nsxlib.load_balancer
        service_client = nsxlib_lb.service
        vs_client = nsxlib_lb.virtual_server
        ...
        self.successful_completion(context, listener_obj, delete=True)
