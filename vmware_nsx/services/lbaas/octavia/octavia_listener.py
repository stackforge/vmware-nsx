...
class NSXOctaviaListener(object):
    ...
    def __init__(self, loadbalancer=None, listener=None, pool=None,
        ...
        endpoints = [NSXOctaviaEndpoint(loadbalancer=None, listener=None,
                                        pool=None, member=None,
                                        healthmonitor=None,
                                        l7policy=None, l7rule=None)]
...
class NSXOctaviaEndpoint(object):
    ...
    def loadbalancer_delete(self, ctxt, loadbalancer_id, cascade=False):
        # TODO(asarfaty): we need the deleted obj
    ...
    def listener_update(self, ctxt, listener):
        # TODO(asarfaty) - missing old_X object
        # TODO(asarfaty) - are we missing the certificate here?
        ctx = neutron_context.Context(None, listener['project_id'])
        self.listener.update(ctx, None, listener)
