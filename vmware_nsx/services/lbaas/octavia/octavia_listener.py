...
class NSXOctaviaListenerEndpoint(object):
    ...
    def update_loadbalancer_statistics(self, statistics):
        self.client.cast({}, 'update_loadbalancer_statistics', **statistics)
...
class NSXOctaviaStatisticsCollector(object):
    def __init__(self, core_plugin, lb_stats_getter, listener_stats_getter):
        self.core_plugin = core_plugin
        self.lb_stats_getter = lb_stats_getter
    ...
    def collect(self):
        ...
        stats = {
                 'loadbalancers': self.lb_stats_getter(context,
                                                       self.core_plugin),
                 'listeners': self.listener_stats_getter(context,
                                                         self.core_plugin)
        }
        self.core_plugin.octavia_listener.update_loadbalancer_statistics(stats)
