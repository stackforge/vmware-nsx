...
class NSXOctaviaDriver(driver_base.ProviderDriver):
    ...
    def __init__(self):
        ...
        LOG.error("NSXOctaviaDriver init")
...
class NSXOctaviaDriverEndpoint(driver_lib.DriverLibrary):
    ...
    def update_listener_statistics(self, ctxt, statistics):
        # Note(asarfaty): if this is called before an octavia create/update/
        # delete call, the NSX driver is not yet listening, and the statistics
        # will not be updated.
        # Also - those statistics might belong to LBaaS objects without and
        # Octavia driver to listen
        return super(NSXOctaviaDriverEndpoint,
