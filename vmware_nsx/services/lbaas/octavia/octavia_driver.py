...
class NSXOctaviaDriver(driver_base.ProviderDriver):
    ...
    def _get_pool_dict(self, pool_id):
        ...
        #TODO(asarfaty) add the listener here too (for the v member impl)
        return pool_dict
    ...
    def obj_to_dict(self, obj, is_update=False, project_id=None):
        ...
        if obj_type == 'LoadBalancer':
            ...
            # The NSX driver expects a single listener and listeners
...
class NSXOctaviaDriverEndpoint(object):
    ...
    def set_completion_state(self, ctx, obj_type, obj_id, success):
        ...
        # TODO(asarfaty): in case of delete we should set a different status
