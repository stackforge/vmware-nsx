...
class EdgeL7PolicyManagerFromDict(base_mgr.EdgeLoadbalancerBaseManager):
    ...
    def create(self, context, pol, obj=None, completor=None):
    ...
    def update(self, context, old_pol, new_pol, obj=None, completor=None):
    ...
    def delete(self, context, pol, obj=None, completor=None):
        # get the nsx application rule id and edge id from the nsx DB
        try:
            edge_id, app_rule_id = policy_to_edge_and_rule_id(
                context, pol['id'])
