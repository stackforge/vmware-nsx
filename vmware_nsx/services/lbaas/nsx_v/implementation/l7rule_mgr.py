...
class EdgeL7RuleManagerFromDict(base_mgr.EdgeLoadbalancerBaseManager):
    ...
    def _handle_l7policy_rules_change(self, context, rule, obj, completor,
                                      delete=False):
    ...
    def create(self, context, rule, obj=None, completor=None):
        self._handle_l7policy_rules_change(context, rule, obj, completor)

    def update(self, context, old_rule, new_rule, obj=None, completor=None):
        self._handle_l7policy_rules_change(context, new_rule, obj, completor)
