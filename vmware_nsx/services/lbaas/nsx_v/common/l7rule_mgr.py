...
class EdgeL7RuleManagerFromDict(base_mgr.EdgeLoadbalancerBaseManager):
    ...
    def _handle_l7policy_rules_change(self, context, rule, rule_obj,
                                      delete=False):
    ...
    def create(self, context, rule, rule_obj=None):
        self._handle_l7policy_rules_change(context, rule, rule_obj)

    def update(self, context, old_rule, new_rule, rule_obj=None):
        self._handle_l7policy_rules_change(context, new_rule, rule_obj)
