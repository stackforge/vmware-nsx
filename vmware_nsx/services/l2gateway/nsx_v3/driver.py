...
class NsxV3Driver(l2gateway_db.L2GatewayMixin):
    ...
    @property
    def _l2gwplugin(self):
        return (manager.NeutronManager.
                get_service_plugins().get(l2gw_const.L2GW))
    ...
    def _ensure_default_l2_gateway(self):
        ...
        l2_gateway = self._l2gwplugin.create_l2_gateway(admin_ctx, l2gw_dict)
            ...
            if l2gateway['devices'][0]['device_name'] == def_l2gw_uuid:
                if def_l2gw_exists:
                    ...
                    try:
                        ...
                        self._l2gwplugin.delete_l2_gateway(admin_ctx,
                                                           l2gateway['id'])
