...
class NsxTvdL2GatewayDriver(l2gateway_db.L2GatewayMixin):
    ...
    def create_l2_gateway(self, context, l2_gateway):
        d = self._get_driver_for_project(
            context, l2_gateway['l2_gateway']['project_id'])
