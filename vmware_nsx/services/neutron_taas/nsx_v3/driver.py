...
class NsxV3Driver(base_driver.TaasBaseDriver,
    ...
    def _update_port_at_backend(self, context, port_id, switching_profile):
        ...
        # Update body with switching profile.
        switching_profile_ids = nsx_port.get('switching_profile_ids', [])
        switching_profile_ids.append(
            self._get_port_mirroring_profile_resource(switching_profile['id']))
    ...
    def _get_port_mirroring_profile_resource(self, profile_id):
