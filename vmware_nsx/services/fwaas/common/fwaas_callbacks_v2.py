...
# DEBUG ADIT: common code with v1?
class NsxFwaasCallbacksV2(firewall_l3_agent_v2.L3WithFWaaS):
    ...
    def _get_in_ns_ports(self, port_ids):
        ...
        for port_id in port_ids:
            ...
            # DEBUG ADIT also gateway port?? check device owner?
    ...
    # DEBUG ADIT: this api should change and used by the nsxv plugin.

    def get_port_fwg(self, context, port_id):
        """Return the firewall group of this port

        if the FWaaS rules should be added.
        """
