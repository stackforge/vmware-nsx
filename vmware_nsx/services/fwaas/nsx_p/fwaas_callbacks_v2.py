...
class NsxpFwaasCallbacksV2(com_callbacks.NsxFwaasCallbacksV2):
    ...
    def _translate_service(self, domain_id, router_id, rule):
        ...
        detached.
        Global ipv4/ipv6 services will be used if there is not L4 protocol
        """
        ...
        if rule.get('protocol'):
            ...
            l4_protocol = self._translate_protocol(rule.get('protocol'))
            ...
            LOG.error("Creating service %s with tags %s", srv_id, tags)
            ...
            srv_id = self.core_plugin.get_ip_version_service_id(ip_version)
    ...
    def update_router_firewall(self, context, nsxlib, router_id, router,
        ...
        # TODO(asarfaty): add nsxlib api for this?
