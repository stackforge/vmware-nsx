...
class EdgeFwaasVDriverV2(edge_fwaas_driver_base.EdgeFwaasDriverBase):
    """NSX-V driver for Firewall As A Service - V2."""

    def __init__(self):
        LOG.debug("Loading FWaaS V2 NsxVDriver.")
        super(EdgeFwaasVDriverV2, self).__init__()
    ...
    def _update_backend_routers(self, apply_list, fwg_id):
        ...
        for router_id in routers:
            # DEBUG ADIT should add all the rules for this router
    ...
    def _validate_firewall_group(self, firewall_group):
        ...
        #TODO(asarfaty) - reuse this function from the v3 driver
