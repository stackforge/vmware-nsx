...
class NSXv3IPsecVpnDriver(service_drivers.VpnDriver):
    ...
    def _create_vpn_service(self, context, vpnservice):
        ...
        # DEBUG ADIT need an ACTIVE-STANDBY tier0 router
        router_id = vpnservice['router_id']
    ...
    def create_vpnservice(self, context, vpnservice):
        ...
        nsx_service_id = self._create_vpn_service(context, vpnservice)
        LOG.error("DEBUG ADIT nsx service %s", nsx_service_id)
        # DEBUG ADIT in DB table?
    ...
    def delete_vpnservice(self, context, vpnservice):
        # DEBUG ADIT todo delete the service? by db?
        pass
