...
class IPsecPValidator(vpn_validator.VpnReferenceValidator):

    """Validator methods for Vmware NSX-V3 VPN support"""
    def __init__(self, service_plugin):
        super(IPsecPValidator, self).__init__()
    ...
    def check_backend_version(self):
        """For the policy api, vpnaas is always supported"""
    ...
    def _validate_router(self, context, router_id):
        ...
        tier0_router = self._nsxpolicy.tier0.get(tier0_uuid)
        ...
        # DEBUG ADIT - is this still a limitation?
    ...
    def validate_vpnservice(self, context, vpnservice):
        ...
        super(IPsecPValidator, self).validate_vpnservice(
            context, vpnservice)
    ...
    def validate_ipsec_policy(self, context, ipsec_policy):
        # Call general validations
        super(IPsecPValidator, self).validate_ipsec_policy(
    ...
    def validate_ike_policy(self, context, ike_policy):
        # Call general validations
        super(IPsecPValidator, self).validate_ike_policy(
            context, ike_policy)
