...
class NsxVPNPlugin(plugin.VPNDriverPlugin):
    ...
    """
    def update_connection_status(self, context, ipsec_site_conn_id):
    ...
    def update_all_connection_status(self, context):
        ...
        for connection in connections:
            self.update_connection_status(context, connection['id'])

    def get_ipsec_site_connection(self, context,
                                  ipsec_site_conn_id, fields=None):
        # update connection status
        if not fields or 'status' in fields:
            self.update_connection_status(context, ipsec_site_conn_id)
