...
class NsxV3Plugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _create_port_at_the_backend(self, context, port_data,
        ...
        if (port_data[ext_sg.SECURITYGROUPS] and
                not utils.is_bb_version(self._nsx_version)):
    ...
    def create_port(self, context, port, l2gw_port_check=False):
        ...
        if not is_external_net:
            ...
            if sgids and utils.is_bb_version(self._nsx_version):
                try:
    ...
    def delete_port(self, context, port_id,
        ...
        if not self._network_is_external(context, port['network_id']):
            ...
            if utils.is_bb_version(self._nsx_version):
                security.update_lport_with_security_groups(
                    context, nsx_port_id,
    ...
    def _update_port_on_backend(self, context, lport_id,
        ...
        if original_device_id != updated_device_id:
            ...
            if resource_type:
                utils.add_v3_tag(tags_update, resource_type, updated_device_id)
    ...
    def create_security_group(self, context, security_group, default_sg=False):
        ...
        try:
            if utils.is_bb_version(self._nsx_version):
                ...
                membership_criteria = (
                    firewall.get_nsgroup_membership_criteria_for_lport(
            ...
            ns_group = firewall.create_nsgroup(
                name, secgroup['description'], tags, membership_criteria)
