...
class NsxV3Plugin(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def _get_port_name(self, context, port_data, device_owner, device_id):
    ...
    def _create_port_at_the_backend(self, context, neutron_db,
        ...
        name = self._get_port_name(context, port_data, device_owner, device_id)
    ...
    def _update_port_on_backend(self, context, lport_id,
        ...
        name = self._get_port_name(context, updated_port, device_owner,
                                   device_id)
