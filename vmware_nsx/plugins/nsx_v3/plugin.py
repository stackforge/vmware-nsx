...
class NsxV3Plugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _init_dns_handler(self):
        # Register NSXv3 DNS driver to support dns-integration extension.
        self._dns_handler = dns_driver.DNSExtensionDriverNSXv3()
    ...
    def _extend_network_dict_dns(self, result, netdb):
        self._dns_handler.extend_network_dict(None, netdb, result)

    def _extend_port_dict_dns(self, result, portdb):
        self._dns_handler.extend_port_dict(None, portdb, result)
    ...
    def create_network(self, context, network):
        ...
        try:
            with context.session.begin(subtransactions=True):
                ...
                self._dns_handler.process_create_network(context, net_data,
                                                         created_net)
    ...
    def update_network(self, context, id, network):
        ...
        self._dns_handler.process_update_network(context, net_data,
                                                 updated_net)
    ...
    def create_port(self, context, port, l2gw_port_check=False):
        ...
        with context.session.begin(subtransactions=True):
            ...
            self._dns_handler.process_create_port(context, port_data,
                                                  neutron_db)
    ...
    def update_port(self, context, id, port):
        ...
        with context.session.begin(subtransactions=True):
            ...
            self._dns_handler.process_update_port(context, port['port'],
                                                  updated_port)
