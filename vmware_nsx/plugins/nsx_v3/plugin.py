...
class NsxV3Plugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _is_ddi_supported_on_net_with_type(self, context, network_id):
        # TODO(asarfaty) rewrite this method, especially if called from
        # create_network, and all the data is already there (calls get_network
        # twice)
        ...
        # NSX currently does not support flat network ports for
        # DHCP and metadata
    ...
    def create_network(self, context, network):
        ...
        try:
            ...
            with db_api.context_manager.writer.using(context):
                ...
                created_net[az_def.AZ_HINTS] = az_hints
                created_net[az_def.COLLECTION_NAME] = [az.name]
