...
class NsxV3Plugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _create_network_at_the_backend(self, context, net_data, az,
        ...
        self._assert_or_override_ens_with_portsecurity(physical_net, net_data)
    ...
    def _assert_or_override_ens_with_portsecurity(self, tz_id, net_data):
        if tz_id and self._is_ens_tz(tz_id):
    ...
    def update_network(self, context, id, network):
        ...
        if extern_net:
            ...
            self._assert_on_ens_with_qos(self._get_net_tz(context, id),
                                         net_data)
            self._assert_or_override_ens_with_portsecurity(
