...
class NsxV3Plugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _get_lb_profiles(self):
        lb_profiles = {}
        if not (hasattr(self, 'client_ssl_profile')
        ...
        if not (hasattr(self, 'server_ssl_profile')
        ...
        lb_profiles['client_ssl_profile'] = self.client_ssl_profile
        lb_profiles['server_ssl_profile'] = self.server_ssl_profile
        return lb_profiles
