...
class NsxV3Plugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _create_fw_section_for_secgroup(self, nsgroup):
        # security-group rules are located in a dedicated firewall section.
        firewall_section = (
            firewall.create_empty_section(
                nsgroup['display_name'], nsgroup['description'], [nsgroup['id']],
                nsgroup['tags'], operation=firewall.INSERT_BEFORE,
    ...
    def _create_security_group_backend_resources(self, secgroup):
        ...
        firewall_section = self._create_fw_section_for_secgroup(ns_group)
