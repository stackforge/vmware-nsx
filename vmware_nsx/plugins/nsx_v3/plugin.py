...
class NsxV3Plugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def get_extra_fw_rules(self, context, router_id, port_id=None):
        ...
        if port_id:
            ...
            for port in ports:
                relay_servers.extend(self._get_port_relay_servers(
                    elv_ctx, port['id'], port['network_id']))
        ...
        if relay_servers:
            ...
            if self.fwaas_callbacks:
                relay_target = (self.fwaas_callbacks.fwaas_driver.
                    translate_addresses_to_target(relay_servers))
            ...
            dhcp_services = [service1, service2]
            # ingress rule
            extra_rules.append({
