...
class NsxTVPlugin(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def create_router(self, context, router):
        ...
        # TODO(asarfaty) verify that the GW network belongs to the same plugin
    ...
    def add_router_interface(self, context, router_id, interface_info):
        p = self._get_plugin_from_router_id(context, router_id)
        # TODO(asarfaty) verify that the network belongs to the same plugin
    ...
    def create_floatingip(self, context, floatingip):
        LOG.error("DEBUG ADIT create_floatingip %s", floatingip)
