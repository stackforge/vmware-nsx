...
class NsxKunePlugin(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def get_networks(self, context, filters=None, fields=None,
                     ...
                     page_reverse=False):
        networks = (self._v.get_networks(context, filters=filters,
                                         fields=fields, sorts=sorts,
                                         limit=limit, marker=marker,
                                         page_reverse=page_reverse) +
                    self._t.get_networks(context, filters=filters,
                                         fields=fields, sorts=sorts,
                                         limit=limit, marker=marker,
                                         page_reverse=page_reverse))
        return networks  # may have two dicts - need to check/clean)
