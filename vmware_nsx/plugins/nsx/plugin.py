...
class NsxKunePlugin(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def _get_plugin_from_net_id(self, context, net_id):
        network = super(NsxKunePlugin, self)._get_network(context, net_id)
        LOG.debug("DEBUG ADIT _get_plugin_from_net_id %s", network)
        return self._get_plugin_from_az(network)
    ...
    def create_security_group(self, context, security_group,
        ...
        try:
            ...
            with excutils.save_and_reraise_exception():
                ...
                super(NsxKunePlugin, self).delete_security_group(context,
                                                                 sg['id'])
        return sg
