...
class NsxPolicyPlugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _prepare_default_rules(self):
        # TODO(asarfaty): Lock this method so that only one worker can run it
        # TODO(asarfaty): return if the domain was already created
        ...
        try:
            ...
            try:
                self.nsxpolicy.comm_map.create_or_overwrite_map_only(
                    ...
                    domain_id=NSX_P_DEFAULT_SECTION,
