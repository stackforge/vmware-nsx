...
class NsxPolicyPlugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _get_port_network_segment_id(self, context, network_id):
        """Return the segment ID the port will reside on at the NSX backend"""
    ...
    def _create_port_at_the_backend(self, context, port_data):
        ...
        segment_id = self._get_port_network_segment_id(
