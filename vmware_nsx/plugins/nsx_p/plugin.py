...
class NsxPolicyPlugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _create_security_group_backend_resources(self, context, secgroup, domain_id):
    ...
    def _create_security_group_backend_rule(self, context, domain_id, map_id, sg_rule,
                                            secgroup_logging):
