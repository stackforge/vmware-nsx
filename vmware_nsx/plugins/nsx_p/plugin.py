...
class NsxPolicyPlugin(agentschedulers_db.AZDhcpAgentSchedulerDbMixin,
    ...
    def _get_network_segment_id(self, context, network_id):
    ...
    def _create_port_on_backend(self, context, port_data):
        ...
        segment_id = self._get_network_segment_id(
    ...
    def create_port(self, context, port, l2gw_port_check=False):
        port_data = port['port']
        print "DEBUG ADIT create_port port_data %s" % port_data
        ...
        with db_api.CONTEXT_WRITER.using(context):
            ...
            print "DEBUG ADIT create_port neutron_db %s" % neutron_db
            port["port"].update(neutron_db)

            # DEBUG ADIT - move to common code
            if direct_vnic_type:
        ...
        print "DEBUG ADIT create_port return port_data %s" % port_data
        return port_data
    ...
    def add_router_interface(self, context, router_id, interface_info):
        ...
        segment_id = self._get_network_segment_id(context, network_id)
