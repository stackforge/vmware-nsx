...
class NsxPolicyPlugin(nsx_plugin_common.NsxPluginV3Base):
    ...
    def _get_subnet_cidr_prefix(self, subnet):
        return int(subnet['cidr'].split('/')[1])
        ...
        try:
            ...
            if overlay_net:
                ...
                for subnet in subnets:
                    cidr_prefix = self._get_subnet_cidr_prefix(subnet)
                    gw_addr = "%s/%s" % (subnet['gateway_ip'], cidr_prefix)
                    pol_subnet.append(policy_defs.Subnet(
