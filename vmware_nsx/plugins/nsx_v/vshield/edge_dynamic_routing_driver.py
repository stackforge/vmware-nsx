...
class EdgeDynamicRoutingDriver(object):
    ...
    def _get_routing_global_config(self, edge_id):
        _, config = self.vcns.get_dynamic_routing_service(edge_id)
    ...
    def _get_routing_bgp_config(self, edge_id):
        _, config = self.vcns.get_bgp_routing_config(edge_id)
    ...
    def add_bgp_speaker_config(self, edge_id, router_id, local_as, enabled,
                               bgp_neighbours, prefixes, redistribution_rules):
    ...
    def add_bgp_neighbour(self, edge_id, bgp_neighbour):
    ...
    def delete_bgp_neighbour(self, edge_id, bgp_neighbour):
        self._update_bgp_routing_config(edge_id,
