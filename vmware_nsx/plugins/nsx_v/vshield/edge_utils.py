...
class EdgeManager(object):
    ...
    def reconfigure_shared_edge_metadata_port(self, context, org_router_id):
        ...
        if not net_list:
            return
        # prepare a list of all availability zones internal networks.
        # Some of those are irrelevant, but no ports will be found anyway
        internal_nets = [net['network_id'] for net in net_list]
