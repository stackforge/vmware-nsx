...
class NsxVPluginV2(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def _create_network(self, context, network, net_data,
        ...
        try:
            ...
            # allowing multiple addresses defined per port but doesn't want
            # to disable spoofguard globally
            sg_policy_id = None
            allow_multiple_addresses = False
            if (cfg.CONF.nsxv.spoofguard_enabled and
                    cfg.CONF.nsxv.enable_multiple_ips_per_vm and not
                    net_data[psec.PORTSECURITY]):
    ...
    def update_network(self, context, id, network):
        ...
        if (cfg.CONF.nsxv.spoofguard_enabled and
                cfg.CONF.nsxv.enable_multiple_ips_per_vm and psec_update and
    ...
    def _validate_address_pairs(self, attrs, db_port):
        if not (cfg.CONF.nsxv.enable_multiple_ips_per_vm and
