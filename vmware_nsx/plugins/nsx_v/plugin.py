...
class NsxVPluginV2(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def _process_subnet_ext_attr_update(self, session, id, subnet):
        update_dns_search_domain = False
        # Update dns search domain attribute for subnet
        if ext_dns_search_domain.DNS_SEARCH_DOMAIN in subnet:
            updated_dns_search_domain = subnet.get(
                ext_dns_search_domain.DNS_SEARCH_DOMAIN)
            ...
            elif sub_binding.dns_search_domain != updated_dns_search_domain:
