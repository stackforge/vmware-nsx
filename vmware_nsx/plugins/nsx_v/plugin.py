...
class NsxVPluginV2(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def __init__(self):
        ...
        if not self._use_nsx_policies:
            #TODO(asarfaty): add support for tenant sg with rules too
    ...
    def _validate_security_group_create(self, security_group, default_sg):
        if self._use_nsx_policies:
            # must have a policy (unless flag allows it):
    ...
    def update_security_group(self, context, id, security_group):
        ...
        # security groups with NSX policy, and no rules
    ...
    def create_security_group_rule_bulk(self, context, security_group_rules):
        ...
        """
        if self._use_nsx_policies:
            # If policies are enabled - this should be disabled
            return
