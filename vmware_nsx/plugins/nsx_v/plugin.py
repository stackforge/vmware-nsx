...
class NsxVPluginV2(addr_pair_db.AllowedAddressPairsMixin,
    ...
    def update_router(self, context, router_id, router):
        ...
        if gw_info and not gw_info.get('enable_snat',
