...
class NSXAvailabilityZonesPluginCommon(object):
    # DEBUG ADIT - find a way to init it here, and do it nicer
    # Also better not to use this obj directly from the plugin
    _availability_zones_data = None
    ...
    def get_obj_az_by_hints(self, object):
