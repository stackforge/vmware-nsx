...
nsxv_opts = [
    ...
    cfg.StrOpt('metadata_service_allowed_ports',
               help=_('Comma separated list of tcp ports, to be allowed '
                'access to the metadata proxy, in addition to the default '
