...
# DEBUG ADIT no db access in nsxlib
...
class Security(object):
    ...
    def _get_remote_nsg_mapping(self, context, sg_rule, nsgroup_id):
        LOG.error(_LE("DEBUG ADIT is this method tested??"))
        ...
        if remote_group_id == sg_rule['security_group_id']:
            ...
            # DEBUG ADIT - no db access from nsxlib
            remote_nsgroup_id = db.get_nsx_security_group_idX(context.session,
                                                              remote_group_id)
