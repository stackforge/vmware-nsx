...
def _disable_shaping_in_args(body, resource_type="EgressRateShaper"):
    for shaper in body["shaper_configuration"]:
        if shaper["resource_type"] == resource_type:
...
def update_qos_switching_profile_shaping(profile_id, egress=None, ingress=None,
