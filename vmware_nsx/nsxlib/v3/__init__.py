...
class NsxLibApi(object):

    def __init__(self, client, max_attempts):
        self.client = client
        self.max_attempts = max_attempts
        super(NsxLibApi, self).__init__()
...
class NsxLibPortMirror(NsxLibApi):
...
class NsxLibBridgeEndpoint(NsxLibApi):
...
class NsxLibLogicalSwitch(NsxLibApi):
...
class NsxLibQosSwitchingProfile(NsxLibApi):
...
class NsxLibLogicalRouter(NsxLibApi):
...
class NsxLibEdgeCluster(NsxLibApi):
...
class NsxLibTransportZone(NsxLibApi):
...
class NsxLibBridgeCluster(NsxLibApi):
