...
def create_port_mirror_session(source_ports, dest_ports, direction, tags):
    """Create a PortMirror Session on the backend.

    :param source_ports: List of UUIDs of the port whose traffic is to be
                        mirrored.
    :param dest_ports: List of UUIDs of the port where the mirrored traffic is
                      to be sent.
    :param direction: String representing the direction of traffic to be
                      mirrored. [IN, OUT, BOTH]
    :param tags: nsx backend specific tags.
    """
