...
class RESTClient(object):
    ...
    def __init__(self, host_ip=None, user_name=None,
                 ...
                 cert_file=None):
        self._host_ip = host_ip or cfg.CONF.nsx_v3.nsx_manager
        self._user_name = user_name or cfg.CONF.nsx_v3.nsx_user
        self._password = password or cfg.CONF.nsx_v3.nsx_password
        self._insecure = (cfg.CONF.nsx_v3.insecure
                          if insecure is None
                          else insecure)
        self._url_prefix = url_prefix or ""
        self._default_headers = default_headers or {}
        self._cert_file = cert_file or cfg.CONF.nsx_v3.ca_file
    ...
    def get(self, uuid, headers=None):
        return self.url_get(uuid, headers=None)
    ...
    def url_get(self, url, headers=None):
        return self._rest_call(url, method='GET', body=None, headers=headers)
